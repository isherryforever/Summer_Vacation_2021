...
public class MailService {
    ...
    public void test1(String s){
        ...
        account.setFrom("guo3376373323@163.com"); //假邮箱，请自己申请真实邮箱
        account.setUser("guo3376373323@163.com"); //假邮箱，请自己申请真实邮箱
        account.setPass("HCGNALSVDEDVGTQN"); //假密码，请自己申请真实邮箱
        MailUtil.send(account,"tianhaoyan201@qq.com", "hutool 测试邮件" + DateUtil.now(), s, false);
    }
    @Test
    @Comment("发送html邮件")
    public void test2(){
