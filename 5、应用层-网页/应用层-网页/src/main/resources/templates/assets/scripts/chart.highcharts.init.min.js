  ...
  e(document).ready(function () {
    ...
    (t = {
      ...
      scatter_3d: function () {
        Highcharts.getOptions().colors = e.map(
          ...
          function (e) {
            return {
              ...
              stops: [
                [0, e],
                [1, Highcharts.Color(e).brighten(-0.2).get("rgb")],
              ],
            };
          }
        );
        ...
        return (
          e(t.container).on("mousedown.hc touchstart.hc", function (s) {
            s = t.pointer.normalize(s);
            var n,
              i,
              o = s.pageX,
              a = s.pageY,
              r = t.options.chart.options3d.alpha,
              c = t.options.chart.options3d.beta,
              l = 5;
            e(document).on({
              "mousemove.hc touchdrag.hc": function (e) {
                (i = c + (o - e.pageX) / l),
                  (t.options.chart.options3d.beta = i),
                  (n = r + (e.pageY - a) / l),
                  (t.options.chart.options3d.alpha = n),
                  t.redraw(!1);
              },
            ...
            series: [
              {
                ...
                data: (function () {
                  var e,
                    ...
                    s = new Date().getTime();
                  for (e = -19; e <= 0; e += 1)
                    t.push({ x: s + 1e3 * e, y: Math.random() });
                  return t;
                })(),
              },
            ],
