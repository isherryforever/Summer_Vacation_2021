!(function (e) {
  ...
  e(document).ready(function () {
    return (
      e("#area-chartist-chart").length && t.area(),
      e("#bar-chartist-chart").length && t.bar(),
      e("#bi-polar-area-chartist-chart").length && t.biPolarArea(),
      e("#bi-polar-bar-chartist-chart").length && t.biPolarBar(),
      e("#donut-bar-chartist-chart").length && t.donut(),
      e("#donut-animation-bar-chartist-chart").length && t.donutAnimation(),
      e("#gauge-bar-chartist-chart").length && t.gauge(),
      e("#horizontal-bar-chartist-chart").length && t.horizontalBar(),
      e("#line-chartist-chart").length && t.line(),
      ...
      e("#smil-animation-index-chartist-chart").length &&
        t.smilAnimationIndex(),
      e("#stacked-bar-chartist-chart").length && t.stackedBar(),
      e("#svg-animation-chartist-chart").length && t.svgAnimation(),
      !1
    );
  }),
    (t = {
      area: function () {
        return (
          new Chartist.Line(
            ...
            { low: 0, showArea: !0, fullWidth: !0, axisY: { offset: 10 } }
          ),
          !1
        );
      },
      ...
      biPolarBar: function () {
        ...
        return new Chartist.Bar("#bi-polar-bar-chartist-chart", e, t), !1;
      },
      donut: function () {
        var e = { series: [20, 10, 30, 40] },
          t = function (e, t) {
            return e + t;
          };
        return (
          new Chartist.Pie("#donut-bar-chartist-chart", e, {
            labelInterpolationFnc: function (r) {
              return Math.round((r / e.series.reduce(t)) * 100) + "%";
            },
            donut: !0,
            donutWidth: 80,
            startAngle: 270,
        ...
        return (
          e.on("draw", function (e) {
            if ("slice" === e.type) {
              ...
              0 !== e.index &&
                (r["stroke-dashoffset"].begin =
                  "anim" + (e.index - 1) + ".end"),
                e.element.attr({ "stroke-dashoffset": -t + "px" }),
                e.element.animate(r, !1);
            }
          }),
      ...
      pie: function () {
        ...
        return (
          new Chartist.Pie("#pie-bar-chartist-chart", e, {
            labelInterpolationFnc: function (r) {
              return Math.round((r / e.series.reduce(t)) * 100) + "%";
            },
          }),
      ...
      scatter: function () {
        ...
        return new Chartist.Line("#scatter-chartist-chart", t, r, i), !1;
      },
      smilAnimation: function () {
        ...
        return (
          ...
          e.on("draw", function (e) {
            if ((t++, "line" === e.type))
              e.element.animate({
                opacity: { begin: t * r + 1e3, dur: i, from: 0, to: 1 },
              });
