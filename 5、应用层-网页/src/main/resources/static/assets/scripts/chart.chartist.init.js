...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if ($("#donut-animation-bar-chartist-chart").length)
      ChartistChart.donutAnimation();
    if ($("#gauge-bar-chartist-chart").length) ChartistChart.gauge();
    if ($("#horizontal-bar-chartist-chart").length)
      ChartistChart.horizontalBar();
    ...
    if ($("#smil-animation-chartist-chart").length)
      ChartistChart.smilAnimation();
    if ($("#smil-animation-index-chartist-chart").length)
      ChartistChart.smilAnimationIndex();
  ...
  ChartistChart = {
    ...
    donutAnimation: function () {
      var chart = new Chartist.Pie(
        "#donut-animation-bar-chartist-chart",
        {
