...
(function (M, a) {
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      ...
      initPath: function (m, f, h) {
        function q(a) {
          for (l = a.length; l--; )
            ("M" !== a[l] && "L" !== a[l]) ||
              a.splice(l + 1, 0, a[l + 1], a[l + 2], a[l + 1], a[l + 2]);
        }
        function n(a, b) {
          for (; a.length < c; ) {
            a[0] = b[c - a.length];
    ...
    a.attr = function (m, f, h) {
      ...
      if (a.isString(f))
        a.defined(h)
          ? m.setAttribute(f, h)
          : m && m.getAttribute && (n = m.getAttribute(f));
    ...
    a.getTZOffset = function (m) {
      ...
      return (
        6e4 *
        ((f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(m)) ||
          f.hcTimezoneOffset ||
          0)
      );
    };
    ...
    a.normalizeTickInterval = function (m, f, h, q, n) {
      ...
      f ||
        ((f = [1, 2, 2.5, 5, 10]),
        !1 === q &&
          (1 === h ? (f = [1, 2, 5, 10]) : 0.1 >= h && (f = [1 / h])));
      for (
        q = 0;
        q < f.length &&
        !((v = f[q]),
        (n && v * h >= m) || (!n && k <= (f[q] + (f[q + 1] || f[q])) / 2));
        q++
      );
      return v * h;
    };
    ...
    a.numberFormat = function (m, f, h, q) {
      ...
      f &&
        ((q = Math.abs(g - v + Math.pow(10, -Math.max(f, k) - 1))),
    ...
    a.getStyle = function (m, f) {
      return "width" === f
        ...
        : (m = J.getComputedStyle(m, void 0)) && a.pInt(m.getPropertyValue(f));
    };
    ...
    a.addEvent = function (a, f, h) {
      ...
      a.addEventListener
        ? a.addEventListener(f, h, !1)
        : a.attachEvent &&
          (a.hcEventsIE || (a.hcEventsIE = {}),
      ...
      function n() {
        ...
        if (m.nodeName)
          for (d in (f ? ((a = {}), (a[f] = !0)) : (a = v), a))
            if (v[d]) for (a = v[d].length; a--; ) q(d, v[d][a]);
      }
      var k,
        v = m.hcEvents,
        d;
    ...
    a.animate = function (m, f, h) {
      ...
      a.isObject(h) ||
        ((q = arguments),
        (h = { duration: q[2], easing: q[3], complete: q[4] }));
    ...
    F &&
      ...
      (a.getStyle = function (m, f) {
        ...
        if (h)
          return (
            (m.style.zoom = 1), Math.max(m[h] - 2 * a.getStyle(m, "padding"), 0)
          );
        m =
          m.currentStyle[
            f.replace(/\-(\w)/g, function (a, n) {
              return n.toUpperCase();
            })
          ];
        "filter" === f &&
          (m = m.replace(/alpha\(opacity=([0-9]+)\)/, function (a, n) {
            return n / 100;
          }));
        return "" === m ? 1 : a.pInt(m);
      });
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      colorGradient: function (b, E, p) {
        ...
        b.linearGradient
          ? (A = "linearGradient")
          : b.radialGradient && (A = "radialGradient");
        if (A) {
          c = b[A];
          t = C.gradients;
          l = b.stops;
          ...
          t[H]
            ? (r = t[H].attr("id"))
            : ((c.id = r = "highcharts-" + a.idCounter++),
              (t[H] = S = C.createElement(A).attr(c).add(C.defs)),
              (S.radAttr = d),
              (S.stops = []),
              w(l, function (b) {
                0 === b[1].indexOf("rgba")
                  ? ((e = a.color(b[1])), (g = e.get("rgb")), (y = e.get("a")))
                  : ((g = b[1]), (y = 1));
                b = C.createElement("stop")
                  .attr({ offset: b[0], "stop-color": g, "stop-opacity": y })
                  .add(S);
                S.stops.push(b);
              }));
          G = "url(" + C.url + "#" + r + ")";
      ...
      align: function (a, b, p) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = b), !p || y(p))
          )
      ...
      getBBox: function (a, p) {
        ...
        void 0 !== t &&
          (k =
            t.toString().replace(/[0-9]/g, "0") +
            ["", p || 0, d, A.style.width].join());
        k && !a && (C = u[k]);
        if (!C) {
          ...
          E.isSVG &&
            ...
            p &&
              ((C.width =
                Math.abs(E * Math.sin(e)) + Math.abs(a * Math.cos(e))),
              (C.height =
                Math.abs(E * Math.cos(e)) + Math.abs(a * Math.sin(e)))));
          if (k && 0 < C.height) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (e = 1; e <= d; e++)
            (E = A.cloneNode(0)),
              ...
              p &&
                (m(E, "height", Math.max(m(E, "height") - c, 0)),
                (E.cutHeight = c)),
      ...
      titleSetter: function (a) {
        ...
        b ||
          ((b = g.createElementNS(this.SVG_NS, "title")),
          this.element.appendChild(b));
        b.firstChild && b.removeChild(b.firstChild);
        b.appendChild(
          g.createTextNode(String(r(a), "").replace(/<[^>]*>/g, ""))
        );
      },
      ...
      zIndexSetter: function (a, b) {
        ...
        var d;
        k(a) &&
          ((A.zIndex = a), (a = +a), this[b] === a && (E = !1), (this[b] = a));
        if (E) {
    ...
    D.prototype["stroke-widthSetter"] = D.prototype.strokeSetter = function (
      ...
      this.stroke && this["stroke-width"]
        ? (D.prototype.fillSetter.call(this, this.stroke, "stroke", p),
    ...
    z.prototype = {
      ...
      init: function (a, b, p, e, A, c) {
        ...
        this.alignedObjects = [];
        this.url =
          (L || K) && g.getElementsByTagName("base").length
            ? O.location.href
                .replace(/#.*?$/, "")
                .replace(/([\('\)])/g, "\\$1")
                .replace(/ /g, "%20")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            g.createTextNode("Created with Highcharts 5.0.2")
          );
      ...
      buildText: function (a) {
        for (
          var b = a.element,
            ...
            K = H && H.lineHeight,
            h = H && H.textShadow,
            v = H && "ellipsis" === H.textOverflow,
            O = l.length,
            B = f && !a.added && this.box,
            P = function (a) {
              var b;
              b = /(px|em)$/.test(a && a.style.fontSize)
                ? a.style.fontSize
                : (H && H.fontSize) || c.style.fontSize || 12;
        ...
        t || h || v || f || -1 !== C.indexOf(" ")
          ? ((y = /<.*class="([^"]+)".*>/),
              ...
              w(C, function (e) {
                if ("" !== e || 1 === C.length) {
                  ...
                  if (" " !== e) {
                    ...
                    !t &&
                      E &&
                      (!p && d && q(r, { display: "block" }), m(r, "dy", P(r)));
                    if (f) {
                      l = e.replace(/([^\^])-/g, "$1- ").split(" ");
                      w = "nowrap" === H.whiteSpace;
                      for (
                        var G = 1 < C.length || E || (1 < l.length && !w),
                          K,
                          h,
                          O = [],
                          B = P(r),
                        ...
                        (a.rotation = 0),
                          ...
                          v && k
                            ? ((Q /= 2),
                              "" === I || (!K && 0.5 > Q)
                                ...
                                : ((I = e.substring(
                                    0,
                                    I.length + (K ? -1 : 1) * Math.ceil(Q)
                                  )),
                                  (l = [I + (3 < f ? "\u2026" : "")]),
                                  r.removeChild(r.firstChild)))
                            : K && 1 !== l.length
                            ? (r.removeChild(r.firstChild), O.unshift(l.pop()))
                            : ((l = O),
                              (O = []),
                              l.length &&
                                !w &&
                                ((r = g.createElementNS(A, "tspan")),
                                m(r, { dy: B, x: n }),
                                S && m(r, "style", S),
                                b.appendChild(r)),
                              h > f && (f = h)),
                          l.length &&
                            r.appendChild(
                              g.createTextNode(l.join(" ").replace(/- /g, "-"))
                            );
                      a.rotation = R;
                    }
                    t++;
            ...
            B && B.removeChild(b),
            h && a.applyTextShadow && a.applyTextShadow(h))
          : b.appendChild(
              g.createTextNode(
      ...
      rect: function (a, b, p, e, A, c) {
        ...
        a = t(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: b, width: Math.max(p, 0), height: Math.max(e, 0) };
      ...
      symbol: function (a, b, p, e, A, c) {
        ...
        t
          ? ((E = this.path(l)),
            E.attr("fill", "none"),
            B(E, { symbolName: a, x: b, y: p, width: e, height: A }),
            c && B(E, c))
          : C.test(a) &&
            ((y = a.match(C)[1]),
            (E = this.image(y)),
      ...
      symbols: {
        ...
        callout: function (a, b, p, e, c) {
          ...
          t && t > p && c > b + d && c < b + e - d
            ...
            : t && 0 > t && c > b + d && c < b + e - d
            ? l.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, b + A)
            : c && c > e && t > a + d && t < a + p - d
            ? l.splice(
                23,
                3,
            ...
            : c &&
              ...
              t > a + d &&
              t < a + p - d &&
              l.splice(3, 3, "L", t - 6, b, t, b - 6, t + 6, b, p - A, b);
          return l;
        },
      },
      clipRect: function (b, p, e, c) {
        var A = "highcharts-" + a.idCounter++,
          d = this.createElement("clipPath").attr({ id: A }).add(this.defs);
      ...
      label: function (a, b, p, e, c, A, d, t, l) {
        ...
        R = function () {
          ...
          k(C) &&
            u &&
            ("center" === v || "right" === v) &&
            (a += { center: 0.5, right: 1 }[v] * (C - u.width));
          if (a !== g.x || b !== g.y)
            g.attr("x", a), void 0 !== b && g.attr("y", b);
          g.x = a;
          g.y = b;
        };
        Q = function (a, b) {
  ...
  (function (a) {
    ...
    f(a.SVGElement.prototype, {
      ...
      htmlUpdateTransform: function () {
        if (this.added) {
          ...
          if ("SPAN" === d.tagName) {
            ...
            h !== this.cTT &&
              ((t = a.fontMetrics(d.style.fontSize).b),
              J(y) && this.setSpanRotation(y, b, t),
              F(d, { width: "", whiteSpace: x || "nowrap" }),
              d.offsetWidth > K &&
      ...
      setSpanRotation: function (a, g, c) {
        ...
        e[l + (h ? "Origin" : "-origin")] = e.transformOrigin =
          100 * g + "% " + c + "px";
        F(this.element, e);
      },
    ...
    a.svg ||
      ((z = {
        ...
        init: function (a, e) {
          ...
          e &&
            ((b = d || "span" === e || "img" === e ? b.join("") : a.prepVML(b)),
            (this.element = F(b)));
          this.renderer = a;
        },
        add: function (a) {
        ...
        getSpanCorrection: function (a, e, d, l, g) {
          ...
          g &&
            "left" !== g &&
            ((this.xCorr -= a * d * (0 > b ? -1 : 1)),
            l && (this.yCorr -= y * d * (0 > t ? -1 : 1)),
            J(this.element, { textAlign: g }));
        },
        ...
        shadow: function (a, d, l) {
          ...
          if (a) {
            ...
            for (g = 1; 3 >= g; g++)
              (A = 2 * f + 1 - 2 * g),
                l && (n = this.cutOffPath(p.value, A + 0.5)),
                (k = [
      ...
      (z = {
        ...
        color: function (b, e, c, d) {
          ...
          if (t) {
            ...
            var K,
              ...
              q = function () {
                u = [
                  '\x3cfill colors\x3d"' + B.join(",") + '" opacity\x3d"',
                  E,
                  '" o:opacity2\x3d"',
                  C,
                  '" type\x3d"',
            ...
            n(b, function (b, e) {
              r.test(b[1])
                ? ((g = a.color(b[1])), (p = g.get("rgb")), (A = g.get("a")))
                : ((p = b[1]), (A = 1));
              B.push(100 * b[0] + "% " + p);
              e ? ((E = A), (y = p)) : ((C = A), (w = p));
            });
            if ("fill" === c)
              if ("gradient" === t)
                (c = f.x1 || f[0] || 0),
                  ...
                  (v =
                    'angle\x3d"' +
                    (90 - (180 * Math.atan((f - b) / (h - c))) / Math.PI) +
                    '"'),
                  q();
              else {
                var k = f.r,
                  ...
                  k = function () {
                    J &&
                      ((U = d.getBBox()),
                      (z += (J[0] - U.x) / U.width - 0.5),
                      (D += (J[1] - U.y) / U.height - 0.5),
                      (L *= J[2] / U.width),
                      (m *= J[2] / U.height));
                    v =
                      'src\x3d"' +
            ...
            r.test(b) && "IMG" !== e.tagName
              ? ((g = a.color(b)),
                d[c + "-opacitySetter"](g.get("a"), c, e),
                (k = g.get("rgb")))
              : ((k = e.getElementsByTagName(c)),
        ...
        createElement: function (a) {
          return "rect" === a
            ? this.symbol(a)
            : u.prototype.createElement.call(this, a);
        },
        ...
        symbols: {
          ...
          rect: function (a, e, c, d, l) {
            return u.prototype.symbols[m(l) && l.r ? "callout" : "square"].call(
              0,
              a,
              e,
              c,
  ...
  (function (a) {
    function D() {
      ...
      n.hcMakeTime = function (a, d, h, c, e, l) {
        var g;
        k
          ? ((g = n.UTC.apply(0, arguments)), (g += J(g)))
          : (g = new n(a, d, f(h, 1), f(c, 0), f(e, 0), f(l, 0)).getTime());
        return g;
      };
    ...
    a.defaultOptions = {
      ...
      global: {
        ...
        VMLRadialGradientURL:
          "http://code.highcharts.com/5.0.2/gfx/vml-radial-gradient.png",
      },
      chart: {
        borderRadius: 0,
      ...
      tooltip: {
        ...
        backgroundColor: z("#f7f7f7").setOpacity(0.85).get(),
        borderWidth: 1,
        headerFormat:
  ...
  (function (a) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        u
          ? ((t = { stroke: K, "stroke-width": d.width }),
            d.dashStyle && (t.dashstyle = d.dashStyle))
          : l &&
            (K && (t.fill = K),
            d.borderWidth &&
              ((t.stroke = d.borderColor),
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          c &&
          (u = k.dateTimeLabelFormats[c.higherRanks[w] || c.unitName]);
        this.isFirst = e;
        this.isLast = l;
      ...
      handleOverflow: function (a) {
        var k = this.axis,
          ...
          n = this.label,
          c = this.rotation,
          e = { left: 0, center: 0.5, right: 1 }[k.labelAlign],
          l = n.getBBox().width,
          u = k.getSlotWidth(),
          m = u,
          b = 1,
        ...
        if (c)
          0 > c && h - e * l < w
            ? (t = Math.round(h / Math.cos(c * q) - w))
            : 0 < c &&
              h + e * l > g &&
              (t = Math.round((d - h) / Math.cos(c * q)));
        else if (
          ((d = h + (1 - e) * l),
          h - e * l < w
            ? (m = a.x + m * (1 - e) - w)
      ...
      getPosition: function (a, k, f, d) {
        ...
        return {
          x: a
            ? g.translate(k + f, null, null, d) + g.transB
            : g.left +
              g.offset +
              (g.opposite
                ? ((d && h.oldChartWidth) || h.chartWidth) - g.right - g.left
                : 0),
          y: a
            ? n - g.bottom + g.offset - (g.opposite ? g.height : 0)
            : n - g.translate(k + f, null, null, d) - g.transB,
        };
      },
        ...
        z(t) ||
          (t =
            0 === e.side
              ...
              : 2 === e.side
              ? b.y + 8
              : Math.cos(f.rotation * q) * (b.y - f.getBBox(!1, 0).height / 2));
      ...
      render: function (a, k, v) {
        ...
        if (
          !k &&
          q &&
          (l = d.getPlotLinePath(l + G, q.strokeWidth() * p, k, !0))
        )
          q[this.isNew ? "attr" : "animate"]({ d: l, opacity: v });
        t &&
          (d.opposite && (t[0] = -t[0]),
          K &&
            ((this.mark = y =
              w
                ...
                .add(d.axisGroup)),
            y.attr({ stroke: b, "stroke-width": A })),
          y[K ? "attr" : "animate"]({
        ...
        e &&
          J(N) &&
          ((e.xy = H = this.getLabelPosition(N, H, e, n, u, G, a, x)),
          (this.isFirst && !this.isLast && !f(g.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !f(g.showLastLabel, 1))
            ? (r = !1)
            : !n ||
              d.isRadial ||
              u.step ||
              ...
              k ||
              0 === v ||
              this.handleOverflow(H),
          x && a % x && (r = !1),
          r && J(H.y)
            ? ((H.opacity = v), e[this.isNew ? "attr" : "animate"](H))
            : (h(e), e.attr("y", -9999)),
          (this.isNew = !1));
      },
      destroy: function () {
  ...
  (function (a) {
    ...
    a.Axis.prototype = {
      ...
      init: function (a, b) {
        ...
        this.crosshair = x(
          c.crosshair,
          G(a.options.tooltip.crosshairs)[e ? 0 : 1],
          !1
        );
        var d;
        b = this.options.events;
        -1 === u(this, a.axes) &&
          (e ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
          ...
          for (; r-- && void 0 === u; )
            (d = Math.pow(1e3, r + 1)),
              b >= d &&
                ...
                null !== g[r] &&
                0 !== e &&
                (u = a.numberFormat(e / d, -1) + g[r]);
        void 0 === u &&
          (u =
            1e4 <= Math.abs(e)
              ? a.numberFormat(e, -1)
              : a.numberFormat(e, -1, void 0, ""));
        return u;
      },
        ...
        d(a.series, function (c) {
          if (c.visible || !e.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis)
              ...
              n(c) &&
                n(A) &&
                ((a.dataMin = Math.min(x(a.dataMin, c), c)),
      ...
      translate: function (a, e, c, d, l, g) {
        ...
        e
          ? ((a = (a * A + r - E) / u + d), l && (a = p.lin2val(a)))
          : (l && (a = p.val2lin(a)),
            "between" === g && (g = 0.5),
            (a =
              A * (a - d) * u + r + A * E + (b(g) ? u * g * p.pointRange : 0)));
        return a;
      },
      ...
      getPlotLinePath: function (a, e, c, d, l) {
        ...
        b(l)
          ? this.horiz
            ? ((r = g),
              (u = f - this.bottom),
              (a = c = t(a, A, A + this.width)))
            : ((a = A),
              (c = k - this.right),
              (r = u = t(r, g, g + this.height)))
          : (h = !0);
        return h && !d
          ? null
          : p.renderer.crispLine(["M", a, r, "L", c, u], e || 1);
      },
      ...
      adjustForMinRange: function () {
        ...
        e - b < this.minRange &&
          ...
          (e = J(e)),
          e - b < h && ((c[0] = e - h), (c[1] = x(a.min, e - h)), (b = F(c))));
        this.min = b;
        this.max = e;
      },
      getClosest: function () {
      ...
      setAxisTranslation: function (a) {
        ...
        if (h || u || c)
          r
            ? ((l = r.minPointOffset), (g = r.pointRangePadding))
            : ((p = b.getClosest()),
              d(b.series, function (a) {
                var e = u
                  ? 1
                  : h
                  ? x(a.options.pointRange, p, 0)
                  : b.axisPointRange || 0;
                a = a.options.pointPlacement;
                c = Math.max(c, e);
                b.single ||
                  ((l = Math.max(l, t(a) ? 0 : e / 2)),
      ...
      setTickInterval: function (a) {
        ...
        z = x(c.userMax, l.max);
        t
          ? ((c.linkedParent = p[c.coll][l.linkedTo]),
            (p = c.linkedParent.getExtremes()),
            (c.min = x(p.min, p.dataMin)),
            (c.max = x(p.max, p.dataMax)),
            l.type !== c.linkedParent.options.type && g(11, 1))
          : (!m &&
              n(q) &&
              (c.dataMin >= q
                ? ((I = q), (w = 0))
        ...
        r &&
          (!a && 0 >= Math.min(c.min, x(c.dataMin, c.min)) && g(10, 1),
          (c.min = h(u(c.min), 15)),
          (c.max = h(u(c.max), 15)));
        c.range &&
          n(c.max) &&
          ((c.userMin = c.min = N = Math.max(c.min, c.minFromRange())),
          (c.userMax = z = c.max),
          (c.range = null));
        B(c, "foundExtremes");
        c.beforePadding && c.beforePadding();
        c.adjustForMinRange();
        !(v || c.axisPointRange || c.usePercentage || t) &&
          n(c.min) &&
          n(c.max) &&
          (u = c.max - c.min) &&
          (!n(N) && w && (c.min -= u * w), !n(z) && H && (c.max += u * H));
        b(l.floor)
          ? (c.min = Math.max(c.min, l.floor))
          : b(l.softMin) && (c.min = Math.min(c.min, l.softMin));
        b(l.ceiling)
          ? (c.max = Math.min(c.max, l.ceiling))
          : b(l.softMax) && (c.max = Math.max(c.max, l.softMax));
        m &&
          n(c.dataMin) &&
          ((q = q || 0),
          !n(N) && c.min < q && c.dataMin >= q
            ? (c.min = q)
            : !n(z) && c.max > q && c.dataMax <= q && (c.max = q));
        c.tickInterval =
          c.min === c.max || void 0 === c.min || void 0 === c.max
            ? 1
            : t && !y && G === c.linkedParent.options.tickPixelInterval
            ? (y = c.linkedParent.tickInterval)
            : x(
                y,
                this.tickAmount
                  ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1)
                  : void 0,
                v ? 1 : ((c.max - c.min) * G) / Math.max(c.len, G)
              );
        k &&
          !a &&
      ...
      alignToOthers: function () {
        ...
        !1 !== this.chart.options.chart.alignTicks &&
          !1 !== c.alignTicks &&
          d(this.chart[this.coll], function (c) {
            var e = c.options,
      ...
      unsquish: function () {
        ...
        b
          ? (t =
              ...
              (n(r)
                ? [r]
                : l < x(a.autoRotationLimit, 80) && a.autoRotation)) &&
            d(t, function (a) {
              var b;
              if (a === r || (a && -90 <= a && 90 >= a))
      ...
      getSlotWidth: function () {
        ...
        return (
          ...
          (!b && ((d && d - a.spacing[3]) || 0.33 * a.chartWidth))
        );
      },
      renderUnsquish: function () {
        ...
        else if (r && ((H = { width: u + "px" }), !k))
          for (H.textOverflow = "clip", x = c.length; !g && x--; )
            if (((G = c[x]), (u = e[G].label)))
              u.styles && "ellipsis" === u.styles.textOverflow
                ? u.css({ textOverflow: "clip" })
                : e[G].labelLength > r && u.css({ width: r + "px" }),
                u.getBBox().height > this.len / c.length - (h.h - h.f) &&
                  (u.specCss = { textOverflow: "ellipsis" });
        f.rotation &&
          ((H = {
            width:
      ...
      hasData: function () {
        return (
          ...
          (n(this.min) && n(this.max) && !!this.tickPositions)
        );
      },
      getOffset: function () {
        var a = this,
        ...
        else for (B in g) g[B].destroy(), delete g[B];
        y &&
          y.text &&
          !1 !== y.enabled &&
          (a.axisTitle ||
            ...
            (a.axisTitle = c
              .text(y.text, 0, 0, y.useHTML)
              .attr({ zIndex: 7, rotation: y.rotation || 0, align: B })
              .addClass("highcharts-axis-title")
              .css(y.style)
              .add(a.axisGroup)),
            (a.axisTitle.isNew = !0)),
          k &&
            ((t = a.axisTitle.getBBox()[r ? "height" : "width"]),
            (H = y.offset),
        ...
        q[u] = Math.max(
          q[u],
          a.axisTitleMargin + t + m * a.offset,
          w,
          h && l.length && z ? z[0] : 0
        );
      ...
      getLinePath: function (a) {
        ...
        return b.renderer.crispLine(
          [
            ...
            d ? e : this.top,
            "L",
            d ? b.chartWidth - this.right : l,
            d ? e : b.chartHeight - this.bottom,
          ],
          a
        );
      },
      ...
      getTitlePosition: function () {
        var a = this.horiz,
          ...
          u = d.x || 0,
          f = d.y || 0,
          h = this.chart.renderer.fontMetrics(
      ...
      render: function () {
        ...
        if (a.hasData() || u)
          a.minorTickInterval &&
            !a.categories &&
            d(a.getMinorTickPositions(), function (b) {
            ...
            f.length &&
              (d(f, function (b, c) {
                if (!u || (b >= a.min && b <= a.max))
                  k[b] || (k[b] = new N(a, b)),
                    K && k[b].isNew && k[b].render(c, !0, 0.1),
                    k[b].render(c);
              }),
              G &&
                (0 === a.min || a.single) &&
                (k[-1] || (k[-1] = new N(a, -1, null, !0)), k[-1].render(-1))),
            x &&
              d(f, function (b, e) {
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (n(b) || !d)
          ? (d
              ? n(b) && (l = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (l =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
            ...
            n(c)
              ? ((b = this.categories && !this.isRadial),
                g ||
                  ...
                  e.dashStyle && g.attr({ dashstyle: e.dashStyle })),
                g.show().attr({ d: c }),
                b && !e.width && g.attr({ "stroke-width": this.transA }),
                (this.cross.e = a))
              : this.hideCrosshair())
          : this.hideCrosshair();
      },
  ...
  (function (a) {
    ...
    D.prototype.getTimeTicks = function (a, k, q, c) {
      var e = [],
        ...
        B;
      if (m(k)) {
        b[z.hcSetMilliseconds](
          K >= d.second ? 0 : x * Math.floor(b.getMilliseconds() / x)
        );
        if (K >= d.second)
          b[z.hcSetSeconds](
            K >= d.minute ? 0 : x * Math.floor(b.getSeconds() / x)
          );
        if (K >= d.minute)
          b[z.hcSetMinutes](
            K >= d.hour ? 0 : x * Math.floor(b[z.hcGetMinutes]() / x)
          );
        K >= d.hour &&
          (b[z.hcSetHours](
            K >= d.day ? 0 : x * Math.floor(b[z.hcGetHours]() / x)
          ),
          (t = b[z.hcGetHours]()));
        if (K >= d.day)
          b[z.hcSetDate](
            K >= d.month ? 1 : x * Math.floor(b[z.hcGetDate]() / x)
          );
        K >= d.month &&
          (b[z.hcSetMonth](
            K >= d.year ? 0 : x * Math.floor(b[z.hcGetMonth]() / x)
          ),
          (w = b[z.hcGetFullYear]()));
        ...
        if (z.hcTimezoneOffset || z.hcGetTimezoneOffset)
          (B =
            (!g || !!z.hcGetTimezoneOffset) &&
            (q - k > 4 * d.month || n(k) !== n(q))),
            (b = b.getTime()),
            (b = new z(b + n(b)));
        w = b[z.hcGetFullYear]();
        k = b.getTime();
    ...
    D.prototype.normalizeTimeTickInterval = function (a, f) {
      ...
      for (
        ...
        (c = d[f[0]]),
        (e = f[1]),
        g[l + 1] && a <= (c * e[e.length - 1] + d[g[l + 1][0]]) / 2);
        l++
      );
  ...
  (function (a) {
    ...
    D.prototype.getLogTickPositions = function (a, h, q, n) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (w = this.getLinearTickPositions(a, h, q));
      else if (0.08 <= a)
        for (
          var v = Math.floor(h),
            B,
        ...
        (h = d(h)),
          ...
          (a = m(
            ...
            ((f.tickPixelInterval / (n ? 5 : 1)) * (q - h)) /
              ((n ? v / this.tickPositions.length : v) || 1)
          )),
          (a = J(a, null, z(a))),
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (a, d, f, c) {
        var e = this,
          ...
          g =
            ...
            !e.isHidden &&
            (1 < Math.abs(a - l.x) || 1 < Math.abs(d - l.y)),
      ...
      getAnchor: function (a, d) {
        ...
        this.followPointer &&
          d &&
          (void 0 === d.chartX && (d = c.pointer.normalize(d)),
      ...
      getPosition: function (a, d, f) {
        var c = this.chart,
          ...
          x = function (a, b, c, d) {
            ...
            d < e || d > b - e
              ? (g = !1)
              : (l[a] = d < c / 2 ? 1 : d > b - c / 2 ? b - c - 2 : d - c / 2);
            return g;
          },
          w = function (a) {
            var c = b;
      ...
      refresh: function (a, d) {
        ...
        d = u[0];
        l = u[1];
        !y || (a.series && a.series.noSharedTooltip)
          ? (f = a.getLabelConfig())
          : ((g.hoverPoints = a),
            f &&
              z(f, function (a) {
        ...
        !1 === b
          ? this.hide()
          : (this.isHidden && (k(c), c.attr({ opacity: 1 }).show()),
            this.split
              ? this.renderSplit(b, g.hoverPoints)
              : (c.attr({ text: b.join ? b.join("") : b }),
                c
                  .removeClass(/highcharts-color-[\d]+/g)
                  .addClass(
                    "highcharts-color-" + q(a.colorIndex, f.colorIndex)
                  ),
                c.attr({
      ...
      renderSplit: function (d, f) {
        ...
        z(d.slice(0, d.length - 1), function (a, d) {
          ...
          y ||
            ((t.tt = y =
              l
                .label(null, null, null, d.isHeader && "callout")
            ...
            d.series &&
              (y.connector = l
                .path()
                .addClass("highcharts-tooltip-connector " + G)
                .attr({
          ...
          d.isHeader
            ? ((b = a.height),
              (r = Math.max(
                0,
                Math.min(d.plotX + e.plotLeft - r / 2, e.chartWidth - r)
              )))
            : (r = d.plotX + e.plotLeft - q(h.distance, 16) - r);
          0 > r && (u = !1);
          a =
            (d.series && d.series.yAxis && d.series.yAxis.pos) + (d.plotY || 0);
          a -= e.plotTop;
          c.push({
        ...
        z(c, function (a) {
          ...
          b.isHeader &&
            ((d.anchorX = b.plotX + e.plotLeft), (d.anchorY = d.y - 100));
          c.attr(d);
          b.isHeader ||
            c.connector.attr({
              d: [
                "M",
                b.plotX + e.plotLeft - d.x,
                b.plotY + b.series.yAxis.pos - d.y,
                "L",
                (u ? -1 : 1) * q(h.distance, 16) + b.plotX + e.plotLeft - d.x,
                a.pos + e.plotTop + c.getBBox().height / 2 - d.y,
              ],
            });
        });
      },
  ...
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      normalize: function (a, d) {
        ...
        void 0 === l.pageX
          ? ((e = Math.max(a.x, a.clientX - d.left)), (d = a.y))
          : ((e = l.pageX - d.left), (d = l.pageY - d.top));
      ...
      runPointActions: function (c) {
        ...
        n && (b ? n.noSharedTooltip : n.directTouch) && y
          ? (G = [y])
          : (b || !n || n.options.stickyTracking || (g = [n]),
            q(g, function (a) {
              ...
              a.visible &&
                ...
                (H = a.searchPoint(c, !v && 1 === a.kdDimensions)) &&
                H.series &&
                G.push(H);
            }),
            G.sort(function (a, c) {
              ...
              return 0 !== e && b
                ...
                : 0 !== d
                ? d
                : a.series.group.zIndex > c.series.group.zIndex
                ? -1
                : 1;
            }));
        if (b)
          for (x = G.length; x--; )
            (G[x].x !== G[0].x || G[x].series.noSharedTooltip) &&
              G.splice(x, 1);
        if (G[0] && (G[0] !== this.prevKDPoint || (f && f.isHidden))) {
          ...
          } else if ((f && f.refresh(G[0], c), !n || !n.directTouch))
            G[0].onMouseOver(c);
          this.prevKDPoint = G[0];
          k = !1;
        }
        k &&
          ((g = n && n.tooltipOptions.followPointer),
          f &&
            g &&
            !f.isHidden &&
            ((g = f.getAnchor([{}], c)),
            f.updatePosition({ plotX: g[0], plotY: g[1] })));
        this._onDocumentMouseMove ||
          ((this._onDocumentMouseMove = function (b) {
      ...
      drag: function (a) {
        ...
        (H && H.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(v - d, 2) + Math.pow(p - b, 2)
          )),
          10 < this.hasDragged &&
            ((G = c.isInsidePlot(v - h, p - k)),
            c.hasCartesianSeries &&
              ...
              (this.selectionMarker = H =
                c.renderer
                  .rect(h, k, g ? 1 : n, f ? 1 : r, 0)
                  .attr({
                    fill:
                      e.selectionMarkerFill ||
                      J("#335cad").setOpacity(0.25).get(),
            ...
            H &&
              g &&
              ((d -= v),
              H.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + v })),
            H &&
              f &&
              ((d = b - p),
              H.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + p })),
          ...
          if (this.hasDragged || d)
            q(e.axes, function (e) {
              if (
                e.zoomEnabled &&
                f(e.min) &&
                (d || c[{ xAxis: "zoomX", yAxis: "zoomY" }[e.coll]])
              ) {
                var l = e.horiz,
      ...
      onContainerMouseMove: function (c) {
        ...
        (!this.inClass(c.target, "highcharts-tracker") &&
          !e.isInsidePlot(c.chartX - e.plotLeft, c.chartY - e.plotTop)) ||
          e.openMenu ||
      ...
      onContainerClick: function (a) {
        ...
        c.cancelClick ||
          (e && this.inClass(a.target, "highcharts-tracker")
            ? (k(e.series, "click", n(a, { point: e })),
              c.hoverPoint && e.firePointEvent("click", a))
      ...
      destroy: function () {
        ...
        a.chartCount ||
          (g(h, "mouseup", this.onDocumentMouseUp),
    ...
    F(a.Pointer.prototype, {
      pinchTranslate: function (a, f, n, k, v, d) {
        (this.zoomHor || this.pinchHor) &&
          this.pinchTranslateDirection(!0, a, f, n, k, v, d);
        (this.zoomVert || this.pinchVert) &&
          this.pinchTranslateDirection(!1, a, f, n, k, v, d);
      },
      pinchTranslateDirection: function (a, f, n, k, v, d, g, w) {
        ...
        f < x.min
          ? ((f = x.min), (p = !0))
          : f + b > x.max && ((f = x.max - b), (p = !0));
        p
          ? ((G -= 0.8 * (G - g[c][0])), I || (N -= 0.8 * (N - g[c][1])), n())
          : (g[c] = [G, N]);
        m || ((d[c] = t - q), (d[u] = b));
        d = m ? 1 / y : y;
        v[u] = b;
      ...
      pinch: function (a) {
        var h = this,
          ...
          e =
            1 === d &&
            ((h.inClass(a.target, "highcharts-tracker") && n.runTrackerClick) ||
              h.runChartClick),
          l = {};
        1 < d && (h.initiated = !0);
        ...
        "touchstart" === a.type
          ...
          : k.length &&
            (B ||
              (h.selectionMarker = B = F({ destroy: m, touch: !0 }, n.plotBox)),
            h.pinchTranslate(k, v, c, B, l, g),
            (h.hasPinched = w),
            h.scaleGroups(c, l),
            !w && h.followTouchMove && 1 === d
              ? this.runPointActions(h.normalize(a))
              ...
              ? (m && this.runPointActions(h),
                "touchmove" === h.type &&
                  ...
                  (k = m[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(m[0].chartX - h.chartX, 2) +
                          Math.pow(m[0].chartY - h.chartY, 2)
                      )
                    : !1)),
                f(k, !0) && this.pinch(h))
              : m && this.reset())
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      colorizeItem: function (a, e) {
        a.legendGroup[e ? "removeClass" : "addClass"](
      ...
      positionItem: function (a) {
        ...
        (a = a.legendGroup) &&
          a.element &&
          a.translate(c ? f : this.legendWidth - f - 2 * d - 4, g);
        b && ((b.x = f), (b.y = g));
      },
      ...
      renderItem: function (a) {
        ...
        A ||
          ...
          (a.legendItem = A =
            d
              .text("", r ? b + h : -h, this.baseline || 0, E)
              .css(k(a.visible ? n : m))
        ...
        b = a.checkboxOffset =
          g.itemWidth ||
          a.legendItemWidth ||
          b + h + d.width + w + (C ? 20 : 0);
        this.itemHeight = h = Math.round(a.legendItemHeight || d.height);
        f &&
          this.itemX - p + b > (G || c.chartWidth - 2 * x - p - g.x) &&
          ((this.itemX = p),
        ...
        f
          ? (this.itemX += b)
          : ((this.itemY += q + h + H), (this.lastLineHeight = h));
        this.offsetWidth =
      ...
      getAllItems: function () {
        ...
        f(this.chart.series, function (c) {
          var e = c && c.options;
          c &&
            v(e.showInLegend, m(e.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
              c.legendItems || ("point" === e.legendType ? c.data : c)
            ));
        });
        return a;
      },
      ...
      render: function () {
        ...
        a.lastItemY = 0;
        k ||
          ((a.group = k = d.g("legend").attr({ zIndex: 7 }).add()),
          (a.contentGroup = d.g().attr({ zIndex: 1 }).add(k)),
        ...
        0 < t &&
          0 < v &&
          (m[m.isNew ? "attr" : "animate"](
            m.crisp({ x: 0, y: 0, width: t, height: v }, m.strokeWidth())
          ),
          (m.isNew = !1));
        m[b ? "show" : "hide"]();
        a.legendWidth = t;
      ...
      handleOverflow: function (a) {
        ...
        H.length = 0;
        a > b && !1 !== x.enabled
          ? ((this.clipHeight = n = Math.max(b - 20 - this.titleHeight - q, 0)),
            ...
            m ||
              ((m = c.clipRect = g.clipRect(0, q, 9999, 0)),
              c.contentGroup.clip(m)),
            B(n),
            G ||
              ((this.nav = G = g.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = g
      ...
      scroll: function (a, e) {
        ...
        0 < a &&
          ...
          this.up
            .attr({ fill: 1 === a ? b.inactiveColor : b.activeColor })
            .css({ cursor: 1 === a ? "default" : "pointer" }),
          this.down
            .attr({ fill: a === g ? b.inactiveColor : b.activeColor })
            .css({ cursor: a === g ? "default" : "pointer" }),
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function (a, d) {
        ...
        d.legendSymbol = this.chart.renderer
          .rect(
            c ? (a.symbolWidth - e) / 2 : 0,
            a.baseline - e + 1,
            c ? e : a.symbolWidth,
            e,
            v(a.options.symbolRadius, e / 2)
          )
      ...
      drawLineMarker: function (a) {
        ...
        d &&
          !1 !== d.enabled &&
          ((c = 0 === this.symbol.indexOf("url") ? 0 : d.radius),
          (this.legendSymbol = d =
            f
              .symbol(this.symbol, g / 2 - c, a - c, 2 * c, 2 * c, d)
              .addClass("highcharts-point")
              .add(b)),
          (d.isMarker = !0));
      },
    };
    (/Trident\/7\.0/.test(w.navigator.userAgent) || q) &&
      B(D.prototype, "positionItem", function (a, d) {
        var c = this,
          e = function () {
    ...
    C.prototype = {
      ...
      getChartSize: function () {
        ...
        this.chartHeight = Math.max(
          0,
          I(a, 19 < this.containerHeight ? this.containerHeight : 400)
        );
      },
      cloneRenderTo: function (a) {
        ...
        if (a) {
          ...
          c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
            ...
            v(b, { position: "absolute", top: "-9999px", display: "block" }),
            b.style.setProperty &&
      ...
      getContainer: function () {
        ...
        this.renderer = new (a[e.renderer] || O)(
          c,
          g,
          f,
          null,
      ...
      getMargins: function (a) {
        ...
        e &&
          ...
          (this.plotTop = Math.max(
            this.plotTop,
            e + this.options.title.margin + b[0]
          ));
      ...
      setChartSize: function (a) {
        ...
        this.plotHeight = n = Math.max(
          0,
          Math.round(e - p - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(d, h[2]) / 2 - c)
          ),
        };
        a ||
      ...
      drawChartBox: function () {
        ...
        l = { fill: l || "none" };
        if (r || e["stroke-width"])
          (l.stroke = a.borderColor), (l["stroke-width"] = r);
        ...
        k &&
          (h
            ? h.animate(G)
            : (this.plotBGImage = b.image(k, t, H, u, v).add()));
        m
          ? m.animate({ width: x.width, height: x.height })
      ...
      isReadyToRender: function () {
        var a = this;
        return p || P != P.top || "complete" === m.readyState
          ? !0
  ...
  (function (a) {
    ...
    D.prototype = {
      ...
      applyOptions: function (a, d) {
        ...
        void 0 === this.x &&
          g &&
          (this.x = void 0 === d ? g.autoIncrement(this) : d);
        return this;
      },
      ...
      },
      {
          ...
          k(a.axisTypes || [], function (g) {
            k(c[g], function (c) {
              ...
              if (
                b[g] === e.index ||
                (void 0 !== b[g] && b[g] === e.id) ||
                (void 0 === b[g] && 0 === e.index)
              )
                c.series.push(a), (a[g] = c), (c.isDirty = !0);
            });
        ...
        getCyclic: function (a, b, c) {
          ...
          b ||
            ((d = L(e[g], e["_" + g])),
            n(d) ||
              ((e["_" + g] = d = this.chart[f] % h), (this.chart[f] += 1)),
            c && (b = c[d]));
          void 0 !== d && (this[g] = d);
          this[a] = b;
        },
        ...
        generatePoints: function () {
          ...
          for (m = 0; m < f; m++)
            (l = h + m),
              k
                ? ((u[m] = new g().init(this, [d[m]].concat(t(e[m])))),
                  (u[m].dataGroup = this.groupMap[m]))
                : (b[l]
                    ? (n = b[l])
                    : void 0 !== a[l] &&
                      (b[l] = n = new g().init(this, a[l], d[m])),
                  (u[m] = n)),
              (u[m].index = l);
          if (b && (f !== (c = b.length) || k))
            for (m = 0; m < c; m++)
        ...
        translate: function () {
          ...
          for (
            ...
            var D =
                b &&
                g.stacks[
                  (this.negStacks && z < (x ? 0 : u) ? "-" : "") + this.stackKey
                ],
              F;
            ...
            I.plotX = y = m(
              Math.min(
                Math.max(
                  -1e5,
                  c.translate(B, 0, 0, 0, 1, k, "flags" === this.type)
                ),
                1e5
              )
            );
            ...
            I.plotY = q =
              "number" === typeof z && Infinity !== z
                ? Math.min(Math.max(-1e5, g.translate(z, 0, 1, 0, 1)), 1e5)
                : void 0;
            I.isInside =
            ...
            I.isNull ||
              (void 0 !== w && (K = Math.min(K, Math.abs(y - w))), (w = y));
          }
        ...
        setClip: function (a) {
          ...
          !1 !== c.clip &&
            (this.group.clip(a || g ? l : b.clipRect),
          ...
          if (!1 !== h.enabled || this._hasPointMarkers)
            for (d = a.length; d--; )
              (g = a[d]),
                ...
                (t = g.isInside),
                n && e(c) && null !== g.y
                  ? ((c = L(l.symbol, this.symbol)),
                    (g.hasImage = 0 === c.indexOf("url")),
                    (n = this.markerAttribs(g, g.selected && "select")),
                    f
                      ? f[t ? "show" : "hide"](!0).animate(n)
                      : t &&
                        (0 < n.width || g.hasImage) &&
                        (g.graphic = f =
                          b.renderer
                            .symbol(c, n.x, n.y, n.width, n.height, k ? l : h)
                            .add(m)),
                    f && f.attr(this.pointAttribs(g, g.selected && "select")),
                    f && f.addClass(g.getClassName(), !0))
                  : f && (g.graphic = f.destroy());
        },
        ...
        destroy: function () {
          ...
          for (h in a)
            a[h] instanceof K &&
              !a[h].survive &&
              ((e = d && "group" === h ? "hide" : "destroy"), a[h][e]());
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            k(d, function (d, k) {
              ...
              g = Math.min(
                Math.max(Math.round(m.toPixels(L(d.value, u.max), !0)), 0),
                t
              );
              ...
              K = Math.max(e, g);
              m.isXAxis
                ? ((h = { x: y ? K : v, y: 0, width: w, height: t }),
                  q || (h.x = b.plotHeight - h.x))
                : ((h = { x: 0, y: y ? K : v, width: t, height: w }),
                  q && (h.y = b.plotWidth - h.y));
              y &&
                c.isVML &&
                (h = m.isXAxis
                  ? { x: 0, y: x ? v : K, height: h.width, width: b.chartWidth }
                  : {
  ...
  (function (a) {
    ...
    F.prototype.getStacks = function () {
      ...
      h(a.series, function (f) {
        !f.options.stacking ||
          ...
          (f.stackKey = f.type + n(f.options.stack, ""));
      });
    };
    ...
    z.prototype.resetStacks = function () {
      ...
      if (!this.isXAxis)
        for (f in a)
          for (d in a[f])
            a[f][d].touched < this.stacksTouched
              ? (a[f][d].destroy(), delete a[f][d])
              : ((a[f][d].total = null), (a[f][d].cum = 0));
    };
      ...
      if (
        ...
        for (G = 0; G < g; G++)
          (H = a[G]),
            ...
            t[I][H] ||
              (y[I] && y[I][H]
                ? ((t[I][H] = y[I][H]), (t[I][H].total = null))
                : (t[I][H] = new D(b, b.options.stackLabels, x, H, e))),
            (I = t[I][H]),
            null !== F &&
              ((I.points[r] = I.points[this.index] = [n(I.cum, c)]),
              m(I.cum) || (I.base = r),
              (I.touched = b.stacksTouched),
              0 < K.index &&
                !1 === this.singleStacks &&
                (I.points[r][0] = I.points[this.index + "," + H + ",0"][0])),
            "percent" === h
              ? ((x = x ? l : u),
                z && t[x] && t[x][H]
                  ? ((x = t[x][H]),
                    (I.total = x.total =
                      Math.max(x.total, I.total) + Math.abs(F) || 0))
                  : (I.total = J(I.total + (Math.abs(F) || 0))))
              : (I.total = J(I.total + (F || 0))),
            (I.cum = n(I.cum, c) + (F || 0)),
    ...
    n(a.Chart.prototype, {
      ...
      update: function (a, c) {
        ...
        if (g) {
          ...
          for (b in g)
            g.hasOwnProperty(b) &&
              (-1 !== v("chart." + b, this.propsRequireUpdateSeries) &&
                (k = !0),
        ...
        for (b in a) {
          ...
          "chart" !== b &&
            -1 !== v(b, this.propsRequireUpdateSeries) &&
            (k = !0);
        }
        ...
        b = g && g.width;
        g = g && g.height;
        (d(b) && b !== this.chartWidth) || (d(g) && g !== this.chartHeight)
          ? this.setSize(b, g)
          : B(c, !0) && this.redraw();
      },
        ...
        getGraphPath: function (a) {
          var f = m.prototype.getGraphPath,
            ...
            t = function (b, d, f) {
              ...
              var n,
                ...
                g = !0;
              f || h
                ? ((n = (h ? b[0] : b[1]) + f), (m = b[0] + f), (g = !!h))
                : !k && a[d] && a[d].isNull && (n = m = u);
              void 0 !== n &&
                (B.push({
                  plotX: e,
          ...
          for (d = 0; d < a.length; d++)
            if (
              ...
              h || t(d, d - 1, "left"),
                (g && !k && h) ||
                  (B.push(a[d]), w.push({ x: d, plotX: e, plotY: b })),
                h || t(d, d + 1, "right");
          d = f.call(this, B, !0, !0);
          w.reversed = !0;
          g = f.call(this, w, !0, !0);
              ...
              : ((g = a[d] =
                  a.chart.renderer
                    ...
                    .attr({
                      fill: J(
                        h[3],
                        D(h[2]).setOpacity(J(n.fillOpacity, 0.75)).get()
                      ),
                      zIndex: 0,
                    })
                    .add(a.group)),
    ...
    m.spline = D(J, {
      ...
      getPointSpline: function (a, h, m) {
        ...
        if (
          ...
          B += c;
          g > a && g > k
            ? ((g = Math.max(a, k)), (B = 2 * k - g))
            : g < a && g < k && ((g = Math.min(a, k)), (B = 2 * k - g));
          B > m && B > k
            ? ((B = Math.max(m, k)), (g = 2 * k - B))
            : B < m && B < k && ((B = Math.min(m, k)), (g = 2 * k - B));
          h.rightContX = w;
          h.rightContY = B;
        }
        h = [
          "C",
          F(q.rightContX, q.plotX),
          F(q.rightContY, q.plotY),
          F(d, f),
          F(g, k),
          f,
          k,
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var q = Math.min(
            ...
            f = Math.min(
              ...
              h(f.pointWidth, t * (1 - 2 * f.pointPadding))
            );
          a.columnMetrics = {
            width: f,
            offset:
              (t - f) / 2 +
              (b + ((a.columnIndex || 0) + (c ? 1 : 0)) * t - q / 2) *
                (c ? -1 : 1),
          };
        ...
        translate: function () {
          ...
          F(a.points, function (d) {
            ...
            d.barX = m;
            d.pointWidth = v;
            d.tooltipPos = f.inverted
              ? [c.len + c.pos - f.plotLeft - k, a.xAxis.len - m - n / 2, y]
              : [m + n / 2, k + c.pos - f.plotTop, y];
            d.shapeType = "rect";
            d.shapeArgs = a.crispCol.apply(
              a,
              d.isNull ? [d.plotX, c.len / 2, 0, 0] : [m, u, n, y]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function (a, f) {
          ...
          a &&
            this.zones.length &&
            (h =
              ((h = a.getZone()) && h.color) || a.options.color || this.color);
          f &&
            ((f = d.states[f]),
            (m = f.brightness),
            (h =
              f.color ||
              (void 0 !== m && z(h).brighten(f.brightness).get()) ||
              h),
            (k = f[c] || k),
            (g = f.dashStyle || g));
          a = {
        ...
        drawPoints: function () {
          ...
          F(a.points, function (d) {
            ...
            m(d.plotY) && null !== d.y
              ? ((e = d.shapeArgs),
                l
                  ? (k(l), l[g.pointCount < c ? "animate" : "attr"](f(e)))
                  : (d.graphic = l =
                      n[d.shapeType](e)
                        .attr({ class: d.getClassName() })
                        .add(d.group || a.group)),
                l
                  .attr(a.pointAttribs(d, d.selected && "select"))
          ...
          v &&
            (a
              ? ((e.scaleY = 0.001),
                (a = Math.min(
                  f.pos + f.len,
                  Math.max(f.pos, f.toPixels(h.threshold))
                )),
                c ? (e.translateX = a - f.len) : (e.translateY = a),
                d.group.attr(e))
              : ((e[c ? "translateX" : "translateY"] = f.pos),
                d.group.animate(
                  e,
                  J(D(d.options.animation), {
                    step: function (a, c) {
                      d.group.attr({ scaleY: Math.max(0.001, c.pos) });
                    },
                  })
                ),
                (d.animate = null)));
      ...
      },
      {
          ...
          a ||
            (F(f, function (a) {
              var c = a.graphic,
                f = a.shapeArgs;
              c &&
                (c.attr({ r: a.startR || d.center[3] / 2, start: h, end: h }),
                c.animate(
        ...
        translate: function (a) {
          ...
          var d = 0,
            ...
            n =
              (this.endAngleRad =
                (Math.PI / 180) * (h(f.endAngle, n + 360) - 90)) - b,
            t = this.points,
          ...
          for (v = 0; v < x; v++) {
            ...
            e = (Math.cos(m) * a[2]) / 2;
            l = (Math.sin(m) * a[2]) / 2;
            I.tooltipPos = [a[0] + 0.7 * e, a[1] + 0.7 * l];
        ...
        drawPoints: function () {
          ...
          F(a.points, function (d) {
            if (null !== d.y) {
              ...
              k
                ? k.setRadialReference(a.center).attr(c).animate(J(e, h))
                : ((d.graphic = k =
                    f[d.shapeType](e)
                      .addClass(d.getClassName())
                      .setRadialReference(a.center)
                      .attr(h)
                      .add(a.group)),
                  d.visible || k.attr({ visibility: "hidden" }),
                  k.attr(c).attr({ "stroke-linejoin": "round" }).shadow(l, g));
            }
          });
        },
        searchPoint: f,
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                d.r + a,
                d.r + a,
                { innerR: this.shapeArgs.r, start: d.start, end: d.end }
              );
        },
      }
    );
  ...
  (function (a) {
          ...
          J(h, function (c) {
            ...
            if (h && !e) c.dataLabel = h.destroy();
              ...
              if (h)
                ...
                "contrast" === x.color &&
                  (I.color =
                    g.inside || 0 > g.distance || d.stacking
                      ? w.getContrast(c.color || a.color)
                      : "#000000");
                d.cursor && (I.cursor = d.cursor);
                for (t in h) void 0 === h[t] && delete h[t];
                h = c.dataLabel = w[e ? "text" : "label"](
                  y,
                  0,
                  -9999,
                  g.shape,
    ...
    d.prototype.alignDataLabel = function (a, d, f, g, h) {
      var b = this.chart,
        ...
        v =
          this.visible &&
          (a.series.forceDL ||
            b.isInsidePlot(e, Math.round(l), c) ||
            (g && b.isInsidePlot(e, c ? g.x + 1 : g.y + g.height - 1, c))),
      ...
      v &&
        ...
        m(f, { width: n.width, height: n.height }),
        r
          ? ((w = !1),
            ...
            (c = {
              ...
              y:
                g.y +
                f.y +
                { top: 0, middle: 0.5, bottom: 1 }[f.verticalAlign] * g.height,
            }),
            d[h ? "attr" : "animate"](c).attr({ align: u }),
            (e = (r + 720) % 360),
            (e = 180 < e && 360 > e),
            "left" === u
              ? (c.y -= e ? n.height : 0)
              : "center" === u
              ? ((c.x -= n.width / 2), (c.y -= n.height / 2))
              : "right" === u && ((c.x -= n.width), (c.y -= e ? 0 : n.height)))
          : (d.align(f, null, g), (c = d.alignAttr)),
        w
          ? this.justifyDataLabel(d, f, c, n, g, h)
          : k(f.crop, !0) &&
            (v =
              b.isInsidePlot(c.x, c.y) &&
              b.isInsidePlot(c.x + n.width, c.y + n.height)),
        f.shape && !r && d.attr({ anchorX: a.plotX, anchorY: a.plotY }));
    ...
    d.prototype.justifyDataLabel = function (a, d, f, g, h, b) {
      ...
      l = f.x + g.width - n;
      l > c.plotWidth &&
        ("left" === e ? (d.align = "right") : (d.x = c.plotWidth - l),
        (m = !0));
      l = f.y + n;
      0 > l &&
        ("bottom" === k ? (d.verticalAlign = "top") : (d.y = -l), (m = !0));
      l = f.y + g.height - n;
      l > c.plotHeight &&
        ("top" === k ? (d.verticalAlign = "bottom") : (d.y = c.plotHeight - l),
        (m = !0));
    ...
    g.pie &&
      ((g.pie.prototype.drawDataLabels = function () {
        var c = this,
          ...
          T = [0, 0, 0, 0];
        c.visible &&
          (m.enabled || c._hasPointLabels) &&
          (d.prototype.drawDataLabels.apply(c),
          J(e, function (a) {
            a.dataLabel &&
              a.visible &&
              (C[a.half].push(a), (a.dataLabel._pos = null));
          }),
          J(C, function (d, e) {
            var k,
              l,
              ...
              for (
                ...
                (f = d[R]),
                  ...
                  t
                    ? void 0 === t[R].pos
                      ? (Q = "hidden")
                      : ((O = t[R].size), (M = k + t[R].pos))
                    : (M = u),
                  (E = m.justify
                    ? r[0] + (e ? -1 : 1) * (B + w)
                    : c.getX(M < k + 2 || M > l - 2 ? u : M, e)),
                  (p._attr = { visibility: Q, align: F[6] }),
                  (p._pos = {
                  ...
                  null === c.options.size &&
                    ((A = p.width),
                    E - A < b
                      ? (T[3] = Math.max(Math.round(A - E + b), T[3]))
                      : E + A > q - b &&
                        (T[1] = Math.max(Math.round(E + A - q + b), T[1])),
                    0 > M - O / 2
                      ? (T[0] = Math.max(Math.round(-M + O / 2), T[0]))
                      : M + O / 2 > v &&
                        (T[2] = Math.max(Math.round(M + O / 2 - v), T[2])));
          }),
          0 === z(T) || this.verifyDataLabelOverflow(T)) &&
      ...
      (g.pie.prototype.connectorPath = function (a) {
        var c = a.x,
          d = a.y;
        return k(this.options.softConnector, !0)
          ? [
              "M",
              c + ("left" === a[6] ? 5 : -5),
              d,
      ...
      (g.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        null !== f[0]
          ...
          : ((b = Math.max(c[2] - a[1] - a[3], g)),
            (c[0] += (a[3] - a[1]) / 2));
        null !== f[1]
          ? (b = Math.max(Math.min(b, c[2] - Math.max(a[0], a[2])), g))
          : ((b = Math.max(Math.min(b, c[2] - a[0] - a[2]), g)),
            (c[1] += (a[0] - a[2]) / 2));
        b < c[2]
          ? ((c[2] = b),
    ...
    g.column &&
      (g.column.prototype.alignDataLabel = function (a, e, f, g, h) {
  ...
  (function (a) {
    ...
    L = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          w = "rgba(192,192,192," + (u ? 0.0001 : 0.002) + ")";
        if (f && !d)
          for (p = f + 1; p--; )
            "M" === e[p] && e.splice(p + 1, 0, e[p + 1] - n, e[p + 2], "L"),
              ((p && "M" === e[p]) || p === f) &&
                e.splice(p, 0, "L", e[p - 2] + n, e[p - 1]);
        q
          ? q.attr({ d: e })
          : a.graph &&
            ((a.tracker = m
      ...
      pan: function (a, c) {
        ...
        h("xy" === c ? [1, 0] : [1], function (c) {
          ...
          c.series.length &&
            ...
            (c.setExtremes(l, h, !1, !1, { trigger: "pan" }), (e = !0));
          b[d] = f;
        });
        e && b.redraw(!1);
      ...
      select: function (a, c) {
        ...
        b.firePointEvent(
          ...
          function () {
            ...
            b.setState(a && "select");
            c ||
              h(e.getSelectedPoints(), function (a) {
                a.selected &&
                  a !== b &&
      ...
      setState: function (b, c) {
        ...
        if (
          !(
            ...
            !1 === h.enabled ||
            (b && (n || (l && !1 === m.enabled))) ||
            (b && t.states && t.states[b] && !1 === t.states[b].enabled)
          )
        ) {
            ...
            this.state &&
              ...
              w &&
                this.graphic.animate(
                  w,
                  B(u.options.chart.animation, m.animation, k.animation)
                ),
              p && p.hide();
          else {
            if (b && m) {
              ...
              if (p) p[c ? "animate" : "attr"]({ x: w.x, y: w.y });
              else
                k &&
                  ((g.stateMarkerGraphic = p =
                    u.renderer
                      .symbol(k, w.x, w.y, w.width, w.height)
                      .add(g.markerGroup)),
                  (p.currentSymbol = k));
              p && p.attr(g.pointAttribs(this, b));
            }
            p &&
              (p[b && u.isInsidePlot(d, e, u.inverted) ? "show" : "hide"](),
              (p.element.point = this));
          }
          (d = h.halo) && d.size
            ? (v ||
                (g.halo = v = u.renderer.path().add(g.markerGroup || g.group)),
              a.stop(v),
              v[c ? "animate" : "attr"]({ d: this.haloPath(d.size) }),
              v.attr({
                class:
    ...
    q(e.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          b.state !== a &&
          (h([b.group, b.markerGroup], function (c) {
            c &&
  ...
  (function (a) {
    ...
    D.prototype.matchResponsiveRule = function (f, q) {
      ...
      v =
        ...
        function () {
          return (
            this.chartWidth <= m(k.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= m(k.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= m(k.minWidth, 0) &&
            this.chartHeight >= m(k.minHeight, 0)
          );
        };
      ...
      !h[f._id] && v
        ? f.chartOptions &&
          ((h[f._id] = this.currentOptions(f.chartOptions)),
          this.update(f.chartOptions, q))
        : h[f._id] && !v && (this.update(h[f._id], q), delete h[f._id]);
    };
      ...
      function h(a, m, d) {
        ...
        for (g in a)
          if (-1 < F(g, ["series", "xAxis", "yAxis"]))
            for (a[g] = f(a[g]), d[g] = [], k = 0; k < a[g].length; k++)
